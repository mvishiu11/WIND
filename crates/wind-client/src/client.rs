use wind_core::{SubscriptionMode, QosParams, WindValue, Result};
use crate::{Subscriber, RpcClient, Subscription};
...
impl WindClient {
    ...
    pub async fn call_with_timeout(
        ...
        self.rpc_client.call(service_name, method, params, timeout).await
    }
    ...
    pub async fn call_async(
        ...
        self.rpc_client.call_async(service_name, method, params).await
    }
